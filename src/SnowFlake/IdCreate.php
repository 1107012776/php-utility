...
/**
 * https://www.cnblogs.com/njccqx/p/13402169.html
...
class IdCreate
{
    ...
    // 方法二
    public static function scToStr($num, $double = 8){
    ...
    // 方法二
    public static function scToStrInt($num, $double = 8){
        $str = self::scToStr($num, $double);
        $arr = explode('.',$str);
        return $arr[0];
    }
}
